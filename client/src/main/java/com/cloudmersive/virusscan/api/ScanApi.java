...
import com.cloudmersive.virusscan.model.VirusScanResult;
import com.cloudmersive.virusscan.model.WebsiteScanRequest;
import com.cloudmersive.virusscan.model.WebsiteScanResult;
  ...
  private HttpRequest.Builder scanFileRequestBuilder(File inputFile) throws ApiException {
    ...
    if (ApiClient.isChunkedTransferEnabled()) {
        ...
        formDataPublisher = HttpRequest.BodyPublishers.ofInputStream(() -> {
            try { return new java.io.FileInputStream(inputFile); }
