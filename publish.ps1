...
& mvn -f .\client\pom.xml -Psign-artifacts -DskipTests "-Dgpg.keyname=$KEY" "-Dgpg.executable=$env:GPGEXE" "-Dgpg.homedir=$env:GNUPGHOME" -e clean verify org.sonatype.central:central-publishing-maven-plugin:0.9.0:publish
